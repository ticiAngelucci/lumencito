...
const projectsData = {
  1: {
    ...
    image: "https://www.fica.unsl.edu.ar/wp-content/uploads/2022/11/Maestra-Florentina-Carreno-front.jpg",
    raised: 7500,
    goal: 10000,
    donors: 89,
    daysLeft: 15,
  ...
  2: {
    ...
    image: "https://cloudfront-us-east-1.images.arcpublishing.com/infobae/FS7J37BKLZBHNMQPVE2IG7YKLY.jpg",
    raised: 2000,
    goal: 5000,
    donors: 45,
    daysLeft: 25,
  ...
  3: {
    ...
    image: "https://www.elcampitorefugio.org/imgs/uploaded/_978018.jpg",
    raised: 1200,
    goal: 8000,
    donors: 28,
    daysLeft: 40,
